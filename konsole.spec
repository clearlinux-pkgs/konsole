...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/konsole-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/konsole-23.04.0.tar.xz.sig
...
%prep
%setup -q -n konsole-23.04.0
cd %{_builddir}/konsole-23.04.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683654496
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libkonsoleapp.so.23.04.0
/V3/usr/lib64/libkonsoleprivate.so.1
/V3/usr/lib64/libkonsoleprivate.so.23.04.0
...
/usr/lib64/libkonsoleapp.so.23.04.0
/usr/lib64/libkonsoleprivate.so.1
/usr/lib64/libkonsoleprivate.so.23.04.0
