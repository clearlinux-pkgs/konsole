...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/konsole-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/konsole-24.05.0.tar.xz.sig
...
%setup -q -n konsole-24.05.0
cd %{_builddir}/konsole-24.05.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716517972
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkonsoleapp.so.24.05.0
/V3/usr/lib64/libkonsoleprivate.so.24.05.0
...
/usr/lib64/libkonsoleapp.so.24.05.0
/usr/lib64/libkonsoleprivate.so.24.05.0
