...
Version  : 22.08.0
Release  : 57
URL      : https://download.kde.org/stable/release-service/22.08.0/src/konsole-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/konsole-22.08.0.tar.xz
...
%prep
%setup -q -n konsole-22.08.0
cd %{_builddir}/konsole-22.08.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661541429
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkonsoleapp.so.22.08.0
/usr/lib64/libkonsoleprivate.so.1
/usr/lib64/libkonsoleprivate.so.22.08.0
