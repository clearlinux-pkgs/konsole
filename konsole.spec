...
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/konsole-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/konsole-23.08.5.tar.xz.sig
...
%prep
%setup -q -n konsole-23.08.5
cd %{_builddir}/konsole-23.08.5
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708389282
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkonsoleapp.so.23.08.5
/V3/usr/lib64/libkonsoleprivate.so.23.08.5
...
/usr/lib64/libkonsoleapp.so.23.08.5
/usr/lib64/libkonsoleprivate.so.1
/usr/lib64/libkonsoleprivate.so.23.08.5
