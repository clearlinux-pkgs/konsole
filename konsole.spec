...
Version  : 24.02.2
Release  : 81
URL      : https://download.kde.org/stable/release-service/24.02.2/src/konsole-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/konsole-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/konsole-24.02.2.tar.xz.sig
...
%setup -q -n konsole-24.02.2
cd %{_builddir}/konsole-24.02.2
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712877360
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkonsoleapp.so.24.02.2
/V3/usr/lib64/libkonsoleprivate.so.24.02.2
...
/usr/lib64/libkonsoleapp.so.24.02.2
/usr/lib64/libkonsoleprivate.so.24.02.2
