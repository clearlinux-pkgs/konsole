...
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/konsole-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/konsole-23.04.2.tar.xz.sig
...
%prep
%setup -q -n konsole-23.04.2
cd %{_builddir}/konsole-23.04.2
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686513044
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkonsoleapp.so.23.04.2
/V3/usr/lib64/libkonsoleprivate.so.23.04.2
...
/usr/lib64/libkonsoleapp.so.23.04.2
/usr/lib64/libkonsoleprivate.so.1
/usr/lib64/libkonsoleprivate.so.23.04.2
