...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/konsole-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/konsole-24.02.0.tar.xz.sig
...
%prep
%setup -q -n konsole-24.02.0
cd %{_builddir}/konsole-24.02.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710439677
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkonsoleapp.so.24.02.0
/V3/usr/lib64/libkonsoleprivate.so.24.02.0
...
/usr/lib64/libkonsoleapp.so.24.02.0
/usr/lib64/libkonsoleprivate.so.24.02.0
