...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/konsole-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/konsole-24.12.1.tar.xz.sig
...
%setup -q -n konsole-24.12.1
cd %{_builddir}/konsole-24.12.1
%patch -P 1 -p1
pushd ..
cp -a konsole-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736527337
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkonsoleapp.so.24.12.1
/V3/usr/lib64/libkonsoleprivate.so.24.12.1
...
/usr/lib64/libkonsoleapp.so.24.12.1
/usr/lib64/libkonsoleprivate.so.24.12.1
