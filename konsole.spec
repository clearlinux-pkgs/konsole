...
Version  : 22.12.3
Release  : 65
URL      : https://download.kde.org/stable/release-service/22.12.3/src/konsole-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/konsole-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/konsole-22.12.3.tar.xz.sig
...
%prep
%setup -q -n konsole-22.12.3
cd %{_builddir}/konsole-22.12.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677784225
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkonsoleapp.so.22.12.3
/usr/lib64/libkonsoleprivate.so.1
/usr/lib64/libkonsoleprivate.so.22.12.3
