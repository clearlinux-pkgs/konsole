...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/konsole-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/konsole-22.12.1.tar.xz.sig
...
%prep
%setup -q -n konsole-22.12.1
cd %{_builddir}/konsole-22.12.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673290716
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkonsoleapp.so.22.12.1
/usr/lib64/libkonsoleprivate.so.1
/usr/lib64/libkonsoleprivate.so.22.12.1
